...
import BrandDownloadBoxFixtureDownloadOneLoginTokens from '../src/molecule/brand-download-box/test/fixtures/download-one-login-tokens';
...
import SetupHeaderFixtureFromDashboards from '../src/organism/setup-header/test/fixtures/from-dashboards';
...
import PopinCorrectionFixtureFailOpenResourcesWithVideoJoker from '../src/template/app-player/popin-correction/test/fixtures/fail-open-resources-with-video-joker';
