...
// The LinkedIn "in" mark inside its rounded square (the recognizable logo, not bare
// letters). It's a single shape filled with currentColor where the "in" is negative
// space, so on the blue CTA it renders as a white rounded box with the button blue
// showing through the letters.
const LinkedinIcon = props => (
  <svg {...props} viewBox="0 0 448 512" fill="currentColor" aria-hidden="true" focusable="false">
