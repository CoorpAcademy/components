...
test('createGradientBackground with a valid RGB color', t => {
  const result = createGradientBackground('rgba(255, 220, 209, 1)', '81%', '91%');
...
test('createGradientBackground with a valid HEX color', t => {
  const result = createGradientBackground('#D9F4F7', '81%', '91%');
...
test('createGradientBackground with a valid HSL color', t => {
  const result = createGradientBackground('hsla(52, 100%, 91%, 1)', '81%', '91%');
