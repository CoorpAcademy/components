...
import ArrowDownIcon from '@coorpacademy/nova-icons/lib/nova-composition/navigation/arrow-down.web';
import ArrowUpIcon from '@coorpacademy/nova-icons/lib/nova-composition/navigation/arrow-top.web';
