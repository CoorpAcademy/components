...
export createBrandDownloadBox from './molecule/brand-download-box';
export createBrandForm from './organism/brand-form';
export createBrandFormGroup from './molecule/brand-form-group';
export createBrandList from './template/back-office/brand-list';
export createBrandTable from './organism/brand-table';
...
export createPagination from './molecule/pagination';
...
export createSearch from './molecule/search';
...
export createTable from './molecule/table';
