...
import {LOCATION, historyReducer, historyMiddleware, syncStoreWithHistory} from '..';
...
test('should navigate on push', t => {
  ...
  const store = createStore(historyReducer, applyMiddleware(historyMiddleware({history})));
