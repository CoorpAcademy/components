...
test(
  'should unset isCorrect when createAnswer request failed',
  macro,
  reducer,
  {foo: {isCorrect: null}},
  {
...
test(
  'should set correctAnswer and corrections when answer fetch was sent',
  macro,
  reducer,
  {},
  {
  ...
  {foo: {correctAnswer: null, corrections: null}}
);

test(
  'should set correctAnswer and corrections when answer fetch was received',
  macro,
  reducer,
  {},
  {
...
test(
  'should unset correctAnswer and corrections when answer fetch failed',
  macro,
  reducer,
  {foo: {correctAnswer: null, corrections: null}},
  {
