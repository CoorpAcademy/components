...
import {UI_TOGGLE_ACCORDION, selectResource} from '../../../redux/actions/ui/corrections';
import {UI_VIDEO_RESUME, UI_VIDEO_PAUSE, UI_VIDEO_ENDED} from '../../../redux/actions/ui/video';
import statePopinFailure from '../../../redux/view/test/fixtures/popin-correction/popin-failure';
import statePopinSuccess from '../../../redux/view/test/fixtures/popin-correction/popin-success';
import statePopinFailureMultipleAnswers from '../../../redux/view/test/fixtures/popin-correction/state-fail-multiple-answers';
import statePopinExtraLife from '../../../redux/view/test/fixtures/popin-correction/popin-extra-life';
import statePopinRevival from '../../../redux/view/test/fixtures/popin-correction/popin-revival';
