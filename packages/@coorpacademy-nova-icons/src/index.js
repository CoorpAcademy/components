...
import _NovaCompositionPodcastArrowNav from './components/nova-composition/podcast/arrow-nav';
import _NovaCompositionPodcastBackward from './components/nova-composition/podcast/backward';
import _NovaCompositionPodcastBackward10s from './components/nova-composition/podcast/backward-10s';
import _NovaCompositionPodcastForward from './components/nova-composition/podcast/forward';
import _NovaCompositionPodcastForward10s from './components/nova-composition/podcast/forward-10s';
import _NovaCompositionPodcastHeartrounded from './components/nova-composition/podcast/heartrounded';
import _NovaCompositionPodcastPauserounded from './components/nova-composition/podcast/pauserounded';
import _NovaCompositionPodcastPlayrounded from './components/nova-composition/podcast/playrounded';
import _NovaCompositionPodcastSearch2 from './components/nova-composition/podcast/search2';
import _NovaCompositionPodcastSettings2 from './components/nova-composition/podcast/settings2';
...
export const NovaCompositionPodcastArrowNav: Icon = _NovaCompositionPodcastArrowNav;
export const NovaCompositionPodcastBackward: Icon = _NovaCompositionPodcastBackward;
export const NovaCompositionPodcastBackward10s: Icon = _NovaCompositionPodcastBackward10s;
export const NovaCompositionPodcastForward: Icon = _NovaCompositionPodcastForward;
export const NovaCompositionPodcastForward10s: Icon = _NovaCompositionPodcastForward10s;
export const NovaCompositionPodcastHeartrounded: Icon = _NovaCompositionPodcastHeartrounded;
export const NovaCompositionPodcastPauserounded: Icon = _NovaCompositionPodcastPauserounded;
export const NovaCompositionPodcastPlayrounded: Icon = _NovaCompositionPodcastPlayrounded;
export const NovaCompositionPodcastSearch2: Icon = _NovaCompositionPodcastSearch2;
export const NovaCompositionPodcastSettings2: Icon = _NovaCompositionPodcastSettings2;
