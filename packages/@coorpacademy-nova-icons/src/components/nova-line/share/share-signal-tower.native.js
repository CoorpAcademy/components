...
const SvgComponent = props => (
  <Svg viewBox="0 0 24 24" {...props}>
    ...
    <G fill="currentColor">
      ...
      <Path d="M20.485 3.516C18.219 1.249 15.205 0 12 0S5.781 1.249 3.515 3.516C1.248 5.782 0 8.795 0 12s1.248 6.219 3.515 8.486l1.414-1.414A9.935 9.935 0 0 1 2 12a9.928 9.928 0 0 1 2.929-7.07C6.818 3.041 9.329 2 12 2s5.182 1.04 7.071 2.93A9.932 9.932 0 0 1 22 12a9.93 9.93 0 0 1-2.929 7.07l1.414 1.414C22.752 18.219 24 15.206 24 12s-1.248-6.218-3.515-8.484z" />
      <Path d="M12 5c-3.859 0-7 3.14-7 7 0 .891.17 1.766.504 2.6l1.857-.746A4.939 4.939 0 0 1 7 12c0-2.758 2.243-5 5-5s5 2.242 5 5c0 .635-.121 1.259-.359 1.854l1.855.746A6.962 6.962 0 0 0 19 12c0-3.86-3.141-7-7-7z" />
    </G>
  </Svg>
);
