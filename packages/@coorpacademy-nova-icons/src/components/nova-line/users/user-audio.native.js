...
const SvgComponent = props => (
  <Svg viewBox="0 0 24 24" {...props}>
    ...
    <G fill="currentColor">
      ...
      <Path d="M14.019 7.037l-5 1.63a.75.75 0 0 0-.518.713v3.175a1.5 1.5 0 1 0 1.5 1.5c0-.045-.009-.087-.013-.131h.013v-4l3.5-1.141v2.771a1.5 1.5 0 1 0 1.5 1.5c0-.045-.009-.087-.013-.131h.013V7.75a.748.748 0 0 0-.982-.713z" />
    </G>
  </Svg>
);
