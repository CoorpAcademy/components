...
const SvgComponent = props => (
  <svg viewBox="0 0 24 24" {...props}>
    ...
    <g fill="currentColor">
      ...
      <path d="M17 12.051V11h-2v1h-2v8h2v1h2v-1.051c1.14-.232 2-1.243 2-2.449 0-.564-.195-1.081-.513-1.5.318-.418.513-.935.513-1.5 0-1.207-.86-2.217-2-2.449zm0 2.449a.5.5 0 0 1-.5.5H15v-1h1.5a.5.5 0 0 1 .5.5zm-.5 3.5H15v-1h1.5a.5.5 0 0 1 0 1z" />
    </g>
  </svg>
);
