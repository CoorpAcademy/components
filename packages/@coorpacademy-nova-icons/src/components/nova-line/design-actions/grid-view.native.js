...
const SvgComponent = props => (
  <Svg viewBox="0 0 24 24" {...props}>
    ...
    <G fill="currentColor">
      ...
      <Path d="M20.167 7.748A4.969 4.969 0 0 0 21 4.995c0-2.757-2.243-5-5-5s-5 2.243-5 5 2.243 5 5 5a4.966 4.966 0 0 0 2.753-.833L22 12.409l1.414-1.415-3.247-3.246zM13 4.995c0-1.654 1.346-3 3-3s3 1.346 3 3c0 1.655-1.346 3-3 3s-3-1.345-3-3z" />
    </G>
  </Svg>
);
