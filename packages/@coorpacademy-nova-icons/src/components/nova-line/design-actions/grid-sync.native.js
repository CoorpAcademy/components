...
const SvgComponent = props => (
  <Svg viewBox="0 0 24 24" {...props}>
    ...
    <G fill="currentColor">
      ...
      <Path d="M18 0c-3.309 0-6 2.691-6 6h2c0-2.206 1.794-4 4-4s4 1.794 4 4-1.794 4-4 4c-1.07 0-2.074-.416-2.78-1.119l-.047-.054L17 7h-5v5l1.757-1.757A5.958 5.958 0 0 0 18 12c3.309 0 6-2.691 6-6s-2.691-6-6-6z" />
    </G>
  </Svg>
);
