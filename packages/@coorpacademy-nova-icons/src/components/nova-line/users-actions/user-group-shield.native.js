...
const SvgComponent = props => (
  <Svg viewBox="0 0 24 24" {...props}>
    ...
    <G fill="currentColor">
      ...
      <G>
        <Path d="M12.002.006v7c0 3.813 3.797 5.579 5.804 5.98l.196.039.196-.039c2.007-.401 5.804-2.168 5.804-5.98v-7h-12zm10 7c0 2.763-3.154 3.757-3.998 3.973-.826-.216-4.002-1.225-4.002-3.973v-5h8v5z" />
        <Path d="M17.002 9.006h2v-2h2v-2h-2v-2h-2v2h-2v2h2z" />
      </G>
    </G>
  </Svg>
);
