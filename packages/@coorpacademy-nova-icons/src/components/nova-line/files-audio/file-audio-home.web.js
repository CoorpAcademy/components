...
const SvgComponent = props => (
  <svg viewBox="0 0 24 24" {...props}>
    ...
    <g fill="currentColor">
      ...
      <path d="M2 2h10v4h4v5.003h2V4.586L13.414 0H2C.897 0 0 .898 0 2v18c0 1.103.897 2 2 2h7v-2H2V2zM19 22h-4v-4l-2 2v3a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-3l-2-2v4z" />
