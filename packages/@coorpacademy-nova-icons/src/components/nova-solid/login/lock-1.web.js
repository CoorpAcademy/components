...
const SvgComponent = props => (
  <svg viewBox="0 0 24 24" {...props}>
    ...
    <path
      fill="currentColor"
      d="M16 11v-1c0-2.206-1.794-4-4-4s-4 1.794-4 4v1H7v7h10v-7h-1zm-4 5a1.5 1.5 0 1 1 .001-3.001A1.5 1.5 0 0 1 12 16zm2-5h-4v-1c0-1.102.897-2 2-2s2 .898 2 2v1z"
    />
  </svg>
);
