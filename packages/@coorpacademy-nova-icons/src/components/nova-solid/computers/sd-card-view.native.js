...
const SvgComponent = props => (
  <Svg viewBox="0 0 24 24" {...props}>
    ...
    <G fill="currentColor">
      <Path d="M9 16a7 7 0 0 1 7-7V7.362c0-.467-.164-.921-.463-1.28L11.068.72A1.991 1.991 0 0 0 9.531 0H2C.897 0 0 .896 0 2v16c0 1.103.897 2 2 2h8.26A6.965 6.965 0 0 1 9 16zM5 7H3V4h2v3zm3 0H6V4h2v3z" />
