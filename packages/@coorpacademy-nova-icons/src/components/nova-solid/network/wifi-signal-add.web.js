...
const SvgComponent = props => (
  <svg viewBox="0 0 24 24" {...props}>
    ...
    <g fill="currentColor">
      ...
      <path d="M18.678 8.926l1.414-1.414c-4.679-4.679-12.291-4.678-16.97 0l1.414 1.413c3.9-3.898 10.243-3.898 14.142.001zM24 18.998h-3v-3h-2v3h-3v2h3v3h2v-3h3z" />
    </g>
  </svg>
);
