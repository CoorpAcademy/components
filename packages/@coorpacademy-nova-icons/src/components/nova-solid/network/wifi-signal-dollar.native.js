...
const SvgComponent = props => (
  <Svg viewBox="0 0 24 24" {...props}>
    ...
    <G fill="currentColor">
      ...
      <Path d="M18.678 8.926l1.414-1.414c-4.679-4.679-12.291-4.678-16.97 0l1.414 1.413c3.9-3.898 10.243-3.898 14.142.001zM21 16.998h-2a1.001 1.001 0 0 1 0-2h4v-2h-2v-1h-2v1c-1.654 0-3 1.345-3 3 0 1.654 1.346 3 3 3h2a1.001 1.001 0 0 1 0 2h-4v2h2v1h2v-1c1.654 0 3-1.346 3-3 0-1.655-1.346-3-3-3z" />
    </G>
  </Svg>
);
