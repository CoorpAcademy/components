...
const icons: Array<Icon> = [
  ...
  {filePath: path.resolve('./third-party/nova-composition.iconjar/icons/administration-icon.svg')},
  {filePath: path.resolve('./third-party/nova-composition.iconjar/icons/analytics-icon.svg')},
  {filePath: path.resolve('./third-party/nova-composition.iconjar/icons/animation-icon.svg')},
  {filePath: path.resolve('./third-party/nova-composition.iconjar/icons/contentcreation-icon.svg')},
  {filePath: path.resolve('./third-party/nova-composition.iconjar/icons/dashboard-icon.svg')},
  {filePath: path.resolve('./third-party/nova-composition.iconjar/icons/editorialization-icon.svg')},
