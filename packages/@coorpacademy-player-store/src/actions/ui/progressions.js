...
const fetchData =
  (engine: Engine, progressionId: ProgressionId, progressionContent: Content) =>
...
export const openAssistance =
  (progression: Progression) =>
  (dispatch: Dispatch, getState: GetState, {services}: Options): DispatchedAction => {
